...
//            EventBus.getDefault().post(TriggerSearchInputEventBus())
//            finish()
//        }
...
//                    swPinned = !swPinned
//                    if (!swPinned) {
//                        setPinned(groupChat.conversationId)
//                    } else {
//                        setPinned(groupChat.conversationId)
//                    }
//                }

//                binding.itemGroup.swHideChat.setOnClickListener {
//                    DialogConfirmHideChat.Builder(this, groupChat, swHide)
//                            .setOnActionDone(this).show()
//                }
...
//                        startActivity(intent)
        ...
        when (groupChat.myPermission) {
            ConversationTypeConstants.OWNER -> {
                binding.itemGroup.llSettingGroup.show()
            }
        ...
        when (groupChat.type) {
            AppConstants.TYPE_GROUP -> {
                ...
                if (groupChat.isHidden == 1) {
                    ...
                    binding.itemGroup.llPinChat.show()
                    swHide = true
                }
            }
